...
import com.quantego.josqp.DataGenerator_non_cvx;
import com.quantego.josqp.DataGenerator_non_cvx.non_cvx_sols_data;
import com.quantego.josqp.OSQP;
import com.quantego.josqp.OSQP.Data;
import com.quantego.josqp.OSQP.Settings;
import com.quantego.josqp.OSQP.Workspace;

import java.lang.Math;

public class Testnon_cvx {
...
public void test_non_cvx_solve()
{
  ...
  OSQP.Data data;      // Data
  DataGenerator_non_cvx.non_cvx_sols_data sols_data;


  // Populate data
  data = DataGenerator_non_cvx.generate_problem_non_cvx();
  sols_data = DataGenerator_non_cvx.generate_problem_non_cvx_sols_data();
